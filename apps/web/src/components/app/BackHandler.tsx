...
// Web-only BackHandler (Capacitor functionality removed for web build compatibility)
const BackHandler: React.FC = () => {
    ...
    const handleBackButton = useCallback(() => {
        ...
        if (isHomePage) {
            if (exitPressedRef.current) {
                // Second press - show message (can't exit in web)
    ...
    // Web: Listen for browser back button via popstate
    useEffect(() => {
